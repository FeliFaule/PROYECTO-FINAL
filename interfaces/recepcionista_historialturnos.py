...
class Ui_RecepcionistaMainWindow(object):
    def setupUi(self, RecepcionistaMainWindow):
        ...
        RecepcionistaMainWindow.resize(1420, 850)
        ...
        self.titulo.setGeometry(QtCore.QRect(310, 20, 100, 34))
        font = QtGui.QFont()
        ...
        self.boton_nuevo_turno = QtWidgets.QPushButton(self.centralwidget)
        self.boton_nuevo_turno.setGeometry(QtCore.QRect(240, 280, 101, 31))
        ...
        self.boton_salir.setGeometry(QtCore.QRect(360, 280, 101, 31))
        ...
        self.boton_salir.clicked.connect(RecepcionistaMainWindow.close) # type: ignore
