...
# Form implementation generated from reading ui file '../diseños_qt/login.ui'
#
...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.password_label.setGeometry(QtCore.QRect(34, 127, 73, 15))
        ...
        self.login_button.setGeometry(QtCore.QRect(152, 202, 121, 30))
...
"")
        ...
        self.user_data.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.user_data.setText("")
        self.user_data.setObjectName("user_data")
        self.user_label = QtWidgets.QLabel(self.widget)
        self.user_label.setGeometry(QtCore.QRect(34, 93, 50, 15))
        self.user_label.setObjectName("user_label")
        self.password_data = QtWidgets.QLineEdit(self.widget)
        self.password_data.setGeometry(QtCore.QRect(110, 124, 201, 23))
        self.password_data.setInputMask("")
        ...
        LoginWindow.setTabOrder(self.password_data, self.check_view_password)
        LoginWindow.setTabOrder(self.check_view_password, self.login_button)
